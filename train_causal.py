...
parser.add_argument("--use_causal", default=False, type=str2bool)
...
if __name__ == "__main__":
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        for step in range(
            ...
            f.flush()
            # print(
            #     "loss in epoch {} iteration {}: {} pos loss:{} neg loss:{} norm loss:{} trace loss:{} l2_reg:{}".format(epoch, step, loss.item(), 
    ...
    sampler.close()
    print("Done")
    print(f"best NDCG{best_test_ndcg} HR{best_test_hr}")
